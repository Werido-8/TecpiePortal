                ...
                interactivity: {
                  events: {
                    ...
                    onHover: {
                      enable: true,
                      mode: "repulse",
                    },当然，我们可以为主要内容区域添加一个粒子特效背景，这将使页面更加生动和有趣。我们可以使用 `tsparticles` 库来实现这个效果，就像我们在顶部轮播图部分使用的那样。我会修改代码以在主要内容区域添加粒子效果背景。



我将提供更新后的完整 `home-page.tsx` 文件内容，包括新添加的粒子效果背景：

```tsx project="Tecpie_Portal" file="home-page.tsx" type="react"
'use client'
